    ...
    <>
      ...
      <section id="infosCon" className="container-fluid">
          ...
          <div id="howItWorksCol" className="col fade-in-target" style={{ "--delay": `${1 * 200}ms` }}>
            <div id="howItWorksTextCon" className="container-fluid">
              <div id="howItWorksTextRow" className="row">
                <article id="howItWorksTextCol" className="col">
        ...
        <div id="letsTalkRow" className="row">
          <article id="letsTalkCol" className="col fade-in-target" style={{ "--delay": `${1 * 200}ms` }}>
            <div id="letsTalkTextRow" className="row">
              <div id="letsTalkTextCol" className="col">
                ...
                <address className="row">
                  <h5 id="zap" className="col-auto"><img src={IMG.zapIcon} alt="ícone whatsapp" height={30}/> (81) 9.8290.9626</h5>
                  <h5 id="mail" className="col-auto"><img src={IMG.mailIcon} alt="ícone e-mail" height={30}/> comercial@voltaes.com.br</h5>
                </address>
              </div>
            </div>
